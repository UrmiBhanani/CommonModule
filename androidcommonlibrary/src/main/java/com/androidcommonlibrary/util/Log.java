...
public class Log {
	...
	public static void print_i(String mesg) {
		if (Log.DO_SOP) {
			android.util.Log.i("Info", mesg);
		}
	}

	public static void print_e(String title, String mesg) {
		if (Log.DO_SOP) {
			android.util.Log.e(title, mesg);
		}
	}
	
	public static void print_v(String title, String mesg) {
		if (Log.DO_SOP) {
